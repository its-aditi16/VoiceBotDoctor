...
#         text_to_speech_with_elevenlabs(input_text=doctor_response, output_filepath=output_voice_path)
...
#     fn=process_inputs,
#     inputs=[
#         gr.Audio(sources=["microphone"], type="filepath", label="Speak Your Concern"),
